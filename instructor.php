<section class="instructor">
    <div class="container">
        ...
        <div class="title-wrapper">
            <h2 class="h2-instructor-title">Our Teachers</h2>
        </div>
        ...
        <ul class="instructor-list">
            <li>
                <div class="instructor-card">
                    ...
                    <p class="card-subtitle">Database Teacher</p>
            ...
            <li>
                <div class="instructor-card">
                    ...
                    <p class="card-subtitle">Programming Teacher</p>
                    <ul class="card-social-list">
                        <li>
                            <a href="#" class="card-social-link">
                                <ion-icon name="logo-google"></ion-icon>
            ...
            <li>
                <div class="instructor-card">
                    ...
                    <p class="card-subtitle">Designer Teacher</p>
                    <ul class="card-social-list">
                        <li>
                            <a href="#" class="card-social-link">
                                <ion-icon name="logo-google"></ion-icon>
        ...
        <!-- <img src="./assets/images/instructor-vactor-2.svg" alt="Vector line art" class="vector-line"> -->
