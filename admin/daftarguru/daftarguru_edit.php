...
$sql   = "SELECT * FROM daftarguru WHERE idguru='$idguru' ";
...
?>
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="./daftarguru/daftarguru_update.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="idguru" value="<?=$data['idguru'];?>">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Nama Guru:</label>
                                    <input type="text" class="form-control" name="nama_guru" required placeholder="Masukan nama anda" value="<?=$data['nama_guru'];?>">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir:</label>
                                    <input type="date" class="form-control" name="tgl_lahir" required placeholder="Masukan nama anda" value="<?=$data['tgl_lahir'];?>">
                                </div>
                                <div class="form-group">
